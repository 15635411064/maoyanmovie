...
class Cinema_ed extends React.Component{
    ...
    render(){
        return (
            <div className="Cinema_ed">
                <div className="Cinema_ed_header">
                ...
                <div className="Cinema_ed_header_th">
                    <div>
                        <p>{this.state.cinemaData.nm}</p>
                ...
                <div className="Cinema_ed_swiper">
                    <img src={"http://p0.meituan.net/148.208/"+this.state.img[this.state.imgId/1]} alt=""></img>
                        ...
                        <div className="swiper-wrapper">
                            {
                                this.state.movies.map((v,i)=>(
                                    <div className="swiper-slide" key={v.id}>
                                        ...
                                        <img src={"http://p0.meituan.net/148.208/"+this.state.img[i]} alt="" className={"Cinema_ed_img"}/>
                                    </div>
                                ))
                            }
                        </div>
                ...
                <div className={"Cinema_ed_food"}>
                    <div>影院超值套餐</div>
                    <ul>
                        {
                            this.state.divideDealList.map((v,i)=>(
                                <li key={i}>
                                    <img src={"http://p0.meituan.net/440.0/"+this.state.foodImg[i]} alt=""></img>
